...
class BookCopiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create book_copy" do
    assert_difference("BookCopy.count") do
      post book_copies_url, params: { book_copy: { book_id: @book_copy.book_id, heritage_code: @book_copy.heritage_code, status: @book_copy.status } }
    end
  ...
  test "should update book_copy" do
    patch book_copy_url(@book_copy), params: { book_copy: { book_id: @book_copy.book_id, heritage_code: @book_copy.heritage_code, status: @book_copy.status } }
